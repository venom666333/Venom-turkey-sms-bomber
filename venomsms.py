...
while 1:
    ...
    print("""{}
         ═════════════════════════════════════════════                       ════════════════
         ║ AVEA / SMS BOOMBER / BY: VENOM        ║                       ║  Sms: {}     ║                    
         ║ Discord: https://discord.gg/CQCdtC299h    ║                       ║  Ara: {}      ║
         ═════════════════════════════════════════════                       ════════════════
    ...
    if menu == 1:
        ...
        system("cls||clear")
        print(Fore.LIGHTWHITE_EX + "Discord : https://discord.gg/CQCdtC299h ")
        print(Fore.LIGHTWHITE_EX + "By: !        Vénøm İs Gød#1942")
        sleep(12)
    elif menu == 4:
        system("cls||clear")
